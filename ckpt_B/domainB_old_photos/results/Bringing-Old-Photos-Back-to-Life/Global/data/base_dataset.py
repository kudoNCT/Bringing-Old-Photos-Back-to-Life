...
def get_transform(opt, params, method=Image.BICUBIC, normalize=True):
    ...
    # transform_list.append(transforms.Lambda(lambda img: __scale_width(img, opt.loadSize, method)))  ## Here ,
    # We want the shorter side to match 256, and Scale will finish it.
