...
indir="/media/phuonglt/DATA/data"
target_folders=['VOC', 'Real_L_old', 'Real_RGB_old']
out_dir ="/media/phuonglt/DATA/out_put"
###
...
for target_folder in target_folders:
    ...
    #              img_bytes = img_fid.read()
             ...
             wfid.write(struct.pack('i', len(img_path_bytes)))
             wfid.write(img_path_bytes)
